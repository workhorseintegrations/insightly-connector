 ...
 *
 */
public class CreateTestCases extends FunctionalTestCase
{
	@Rule
	...
	@Test
	public void testContactsCreateInvalidData() throws Exception
	{
		String resultMsg = "[{\"Name\":\"apiContact\",\"Message\":\"\"}]";
		MuleClient client = muleContext.getClient();
		MuleMessage _msg = new DefaultMuleMessage("Testing create with invalid data.", muleContext);
		MuleMessage result = client.send("vm://test.create.in", _msg);
